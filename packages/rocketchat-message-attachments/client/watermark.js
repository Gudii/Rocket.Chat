...
(function(w){
	var wm = (function(w){
		...
		applyWatermark = function(img){
			gcanvas.width = img.naturalWidth || img.offsetWidth;
			gcanvas.height = img.naturalHeight || img.offsetHeight;
			...
			gctx.fillStyle = "#c3c3c5";
			gctx.fillText("Copyright (c) 2017 Copyright Holder All Rights Reserved", 5, gcanvas.height - 1)
			img.onload = null;
